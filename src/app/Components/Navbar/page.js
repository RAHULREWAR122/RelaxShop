      ...
      <div className={style.topNav}>
        ...
        <div className={style.men_women}>
          <h4
            ...
            className={`${selectCat === "men" ? style.active : null}`}
          >
            Men's
          </h4>
          <h4
            onClick={() => handleSelectCategory("women")}
            className={`${selectCat === "women" ? style.active : null}`}
          >
            Women's
          </h4>
        </div>
        ...
        <aside className={style.linksNav}>
          ...
          {selectCat === "men" && (
            <div className={style.men}>
              ...
              <li 
                onClick={() => {handleRoutes("/Components/AllPages/Men/Lower") , handleMenuButton() }}
              >
                <span>Lower</span>
                <img
              ...
              <li
                onClick={() =>{ handleRoutes("/Components/AllPages/Men/Jeans") , handleMenuButton() }}
              >
                <span>Jeans</span>
                <img
                  src="/navImgs/mJ.webp"
              ...
              <li
                onClick={() =>{ handleRoutes("/Components/AllPages/Men/Shirts") , handleMenuButton() }}
              >
                <span>Shirts</span>
                <img
          ...
          {selectCat === "women" && (
            <div className={style.men}>
              ...
              <li
                onClick={() =>{ handleRoutes("/Components/AllPages/Women/Jeans") , handleMenuButton() }}
              >
                <span>Jeans</span>
                <img
                  src="/navImgs/wJ.webp"
              ...
              <li
                onClick={() =>{ handleRoutes("/Components/AllPages/Women/Sari"), handleMenuButton() }}
              >
                <span>Sari</span>
                <img
